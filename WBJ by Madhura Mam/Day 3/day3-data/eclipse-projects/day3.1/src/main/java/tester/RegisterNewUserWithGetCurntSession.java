...
public class RegisterNewUserWithGetCurntSession {
	...
	public static void main(String[] args) {
		try (SessionFactory sf = getFactory(); Scanner sc = new Scanner(System.in)) {
			...
			System.out.println("user id "+user.getUserId());//null
			user.setUserId(800);
			//invoke dao's method
			System.out.println(userDao.saveUserDetailsViaGetCurrentSession(user));
