...
public class CategoryController {
	...
	public String showUpdateCategoryForm(@RequestParam Long catId, Model map) {
		...
		map.addAttribute("category", categoryService.getCategoryById(catId));
	...
	@PostMapping("/update")
	public String processUpdateCategoryForm(@RequestParam Long catId, RedirectAttributes flashMap, Category category) {
	...
	//URL : http://localhost:8080/day9_boot/categories/show_products?catName=books
		...
		public String showAddCategoryForm(Category category) {
			System.out.println("in show add category form " +category);
