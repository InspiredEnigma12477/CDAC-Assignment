...
//dep : service layer i.f
	...
	// dep : image hadnling service i/f
	@Autowired
...
//		}
	...
	// URL : http://host:port/employees/{empId}/image_upload
	@PostMapping("/{empId}/image_upload")
	public ResponseEntity<?> uploadImageToServerSideFolder(@PathVariable Long empId,
