...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST)
				.body(new ApiResponse("Validations Failed ", sb.toString()));
	...
	public ResponseEntity<?> handleUserHandlingException(UserHandlingException e) {
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
				.body(new ApiResponse("User Handling Error ", e.getMessage()));
	}
	...
	public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException e) {
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
				.body(new ApiResponse("Invalid a/c no ", e.getMessage()));
	}
	//catch all 
