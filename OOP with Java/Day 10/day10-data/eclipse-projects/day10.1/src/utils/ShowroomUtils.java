...
//add a static method to ret populated list of vehicles
	public static List<Vehicle> populateShowroom() throws ParseException, ShowroomHandlingException {
		...
		vehicles.add(new Vehicle("abc-1230", Color.RED, 32345, parseAndValidateDate("2-5-2022"), "Maruti"));

		vehicles.add(new Vehicle("abc-1238", Color.GREY, 19345, parseAndValidateDate("2-5-2022"), "Maurti"));
