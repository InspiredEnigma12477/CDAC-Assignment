...
<h5> Session ID : ${pageContext.session.id}</h5>
	...
	if (user != null) {
		if (user.getPassword().equals(userPwd)) {
			...
			//URL rewriting for Clnt Pull II
			//API of HttpServletResponse : public String encodeRedirectURL(String location)
			response.sendRedirect(response.encodeRedirectURL("details.jsp"));//CP II
